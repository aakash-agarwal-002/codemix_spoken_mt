...
def get_arg_parse():
    ...
    parser.add_argument("--model", type=str, default="ai4bharat/indictrans2-indic-en-1B")
    parser.add_argument("--output_dir", type=str, default="./phinc_finetuned_hinglish_eng")
