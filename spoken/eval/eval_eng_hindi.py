...
def get_arg_parse():
    parser = argparse.ArgumentParser(description="Evaluation script for EN to HI translation")
...
def main():
    ...
    hindi = test_data["hindi"]

    os.makedirs(args.output_dir, exist_ok=True)

    output_file = (
        "en_to_hindi_results_finetuned.csv"
        if args.use_peft
        else "en_to_hindi_results_base.csv"
    )
    ...
    if os.path.exists(output_path):
        ...
        pred_hindi = df["pred_hindi"].tolist()
